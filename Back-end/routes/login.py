...
def autenticar():
    ...
    try:
        ...
        cursor.execute(
            "SELECT Employer.CodigoFunc, Empresa.Codigo FROM Employer JOIN Empresa ON Employer.Fk_Empresa_Id = Empresa.Id WHERE Employer.CodigoFunc = %s AND Empresa.Codigo = %s;",
